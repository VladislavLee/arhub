    ...
    render() {
        ...
        const title = selected ? (
            <>
                ...
                <div>
                    {selectedEntity && <Icon style={{ display: 'none',marginRight: 4 }} name="gltf" className="editor-icon" onClick={this.handleExportToGLTF} />}
                    <Icon style={{ display: 'none',marginRight: 4 }} name="clipboard" className="editor-icon" onClick={this.handleEntityClipboard} />
                </div>
            </>
        ) : (
            <>
                <Icon name="cog" style={{ display: 'none',marginRight: 4, fontSize: '1.25rem' }} />
                <div>{'Properties'}</div>
            </>
        );
